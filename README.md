...
- `assets/img/hero-1.jpg`, `hero-2.jpg`, `hero-3.jpg` - imagens de fundo do hero (slideshow com crossfade na página inicial)
- `assets/img/usinagem.jpg` - foto de peças usinadas (seção "Quem somos")
